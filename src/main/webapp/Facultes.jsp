        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="addFaculte" class="btn btn-primary">Ajouter Faculté</a>
                </div>
            </div>

            <form action="rechercherFaculte" method="post">
            ...
            <tbody>
                ...
                <c:forEach var="c" items="${listeF}">
                    <tr>
                        <td>${c.nomFac}</td>
                        <td>
                            <a href="modifierFaculte?id=${c.id}" class="btn btn-primary">Modifier</a>
                            <a onclick="return confirm('Voulez vous vraiment supprimer cette faculté?')"
                                href="supprimerFaculte?id=${c.id}" class="btn btn-danger">Supprimer</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
